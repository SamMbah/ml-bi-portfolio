...
def load_sentiment_model():
    ...
    try:
        ...
        # Simple example data for training if no dataset available
        texts = [
        ...
        # If train.csv exists, use it instead
...
if page == "Machine Learning Projects":
    ...
    if project == "IMDB Sentiment Analysis":
        ...
        with tabs[0]:
            ...
            with col2:
                # Load example review function
                if st.button("Load Example Review", key="load_example"):
                    import random
                    user_input = random.choice(example_reviews)
                    st.rerun()
